	...
	<nav>
		<div class="menubar" style="line-height: 35px">
			<ul class="underMenu">
				...
				<li><a class="underMenuFont"
					onclick="location.href='Board_write2.jsp'">질문하기&nbsp;&nbsp;&nbsp; </a></li>
			</ul>
		</div>
	</nav>
	...
	<section style="Height: 1000px;">	
		...
		if( i % 2 == 0 ){%>
				<tr>	
					...
					<td class="even" id="idd"><a href="Board_read.jsp?postid=<%=list.get(i).getPostid()%>"> <% out.println(list.get(i).getPosttitle()); %></a></td>
				...
				<tr>
					...
					<td scope="row" id="idd"><a href="Board_read.jsp?postid=<%=list.get(i).getPostid()%>"><% out.println(list.get(i).getPosttitle()); %></a></td>
